...
for (var i = 0; i < total; i++) {
    ...
    // Criar o efeito primeiro, fora do with
    var efeito = instance_create_layer(_x, _y, "Efeitos", o_raio);
    efeito.x_dest = alvo.x;
    efeito.y_dest = alvo.y;

	show_debug_message("Raio criado em: " + string(_x) + ", " + string(_y));
    // Agora sim aplicar o dano dentro do with
    with (alvo) {
